...
Decisions are recorded as ADRs. [Browse them all](https://git.sr.ht/~ninjapanzer/wavelet/tree/master/item/docs/adr).

- [ADR-0001: Tree storage with inferred cross links](https://git.sr.ht/~ninjapanzer/wavelet/tree/master/item/docs/adr/0001-tree-storage-with-inferred-cross-links.md)
- [ADR-0002: Wake on any blip turn semantics](https://git.sr.ht/~ninjapanzer/wavelet/tree/master/item/docs/adr/0002-wake-on-any-blip-turn-semantics.md)
- [ADR-0003: Single binary zero dep stdlib MCP channel](https://git.sr.ht/~ninjapanzer/wavelet/tree/master/item/docs/adr/0003-single-binary-zero-dep-stdlib-mcp-channel.md)
- [ADR-0004: Memory as Datalog sidecar robot](https://git.sr.ht/~ninjapanzer/wavelet/tree/master/item/docs/adr/0004-memory-as-datalog-sidecar-robot.md)
- [ADR-0005: Operator in band via wrapped sessions](https://git.sr.ht/~ninjapanzer/wavelet/tree/master/item/docs/adr/0005-operator-in-band-via-wrapped-sessions.md)
- [ADR-0006: Membership as log events](https://git.sr.ht/~ninjapanzer/wavelet/tree/master/item/docs/adr/0006-membership-as-log-events.md)
- [ADR-0007: Embedded operator console](https://git.sr.ht/~ninjapanzer/wavelet/tree/master/item/docs/adr/0007-embedded-operator-console.md)
- [ADR-0008: Presence as ephemeral state](https://git.sr.ht/~ninjapanzer/wavelet/tree/master/item/docs/adr/0008-presence-as-ephemeral-state.md)
- [ADR-0009: Targeted delivery rules before models](https://git.sr.ht/~ninjapanzer/wavelet/tree/master/item/docs/adr/0009-targeted-delivery-rules-before-models.md)
- [ADR-0010: Groundwork for a trained attendant](https://git.sr.ht/~ninjapanzer/wavelet/tree/master/item/docs/adr/0010-groundwork-for-a-trained-attendant.md)
- [ADR-0011: Tmux as process supervisor](https://git.sr.ht/~ninjapanzer/wavelet/tree/master/item/docs/adr/0011-tmux-as-process-supervisor.md)
